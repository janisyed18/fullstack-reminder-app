...
const ReminderList = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      fetchReminders(); // Re-fetch to ensure pagination is correct
    } catch (err) {
      setNotification({
        open: true,
              ...
              >
                ...
                >
                  ...
                  <Typography color="text.secondary">
                    Try adjusting your search or filter settings, or create a
                    new reminder!
                  </Typography>
                </Paper>
              </motion.div>
